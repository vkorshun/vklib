...
const
  cAbout = 'MDI Tab Control 1.4 - Copyright © 1999,2002 MichaL MutL';
...
type
  ...
  public
    ...
    procedure AddTab(AChild :TForm; ImageIndex :integer);
...
procedure TMDITab.AddTab(AChild: TForm; ImageIndex: integer);
var
  i :integer;
  ae,de :pnotifyevent;
begin
